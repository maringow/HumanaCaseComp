...
df_holdout_outcomes = pd.read_csv('HOLDOUT_outcomes.csv')
# df_raw = pd.read_csv('C:\\Users\\mgow\\Documents\\Personal\\Humana Case Comp\\HMAHCC_COMP.csv')
df_holdout_raw = pd.read_csv('C:\\Users\\mgow\\Documents\\Personal\\Humana Case Comp\\HMAHCC_HOLDOUT.csv')
...
def add_features(df_raw, df_outcomes):
...
df_comp_outcomes = add_features(df_holdout_raw, df_holdout_outcomes)
df_comp_outcomes.to_csv('df_comp_outcomes.csv')
